...
if (mysqli_num_rows($result) > 0) {
    ...
    <body style="background-image:url(/V10/vendeur/<?php echo $row['nom']; ?>/<?php echo $row['fond']; ?>">
       
        
    <div class="pagevendeur">
        <h1 id="titre">Page de vendeur</h1>
        <img id="profilepicture" src="/V10/vendeur/<?php echo $row['nom']; ?>/<?php echo $row['photo']; ?>" alt="Il manque une image de profil" />
        <h2 id="nom"><?php echo $row['nom']; ?></h2>
        <a id="modifier" href="modifiervendeur.php">Modifier la page</a><br>
