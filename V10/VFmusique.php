...
require 'header.php';
// Requete sql
    $req="SELECT * FROM cataloguemodele cm, catalogue c WHERE c.categorie LIKE 'Musique' AND c.idprod = cm.idprod ORDER BY cm.`nb_vente` DESC";
    ...
    $i=0;
// Titre de la page
echo("<header><h1>BestSellers Musique</h1></header>");
               ...
               echo ("
                <div class ='catalogue'>
                    ...
                    <div class='panierpic'>
                        ...
                        <input type='hidden' name='nomfic' value='VFmusique.php'>
