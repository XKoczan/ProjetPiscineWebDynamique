...
if(isset($_POST['acheter']))
{
  ...
  if(!isset($_SESSION['panier'][$_POST["idmodele"]]))
  {
      ...
      header("Location:ProjetPiscine.html");
  }//Sinon
       ...
       if($temp >= $_POST["stock"])
          {
              ...
              echo("vous avez atteint le nombre maximum d'articles disponibles pour ce produit <a href='window.history.back()'>retour au catalogue</a>");
          }
      //Sinon
...
<div id="carouselExampleControls" class="carousel slide" data-interval="false">
  <div class="carousel-inner">
    ...
    for($i=0;$i<sizeof($photos);$i++)
    {
      if($i==0)
      {
        echo "<div class='carousel-item active'><img class='d-block w-100' src='/catalogue/".$idprod."/".$photos[$i]."' alt='First slide'></div>";
      }
      else{
        echo"<div class='carousel-item'><img class='d-block w-100' src='/catalogue/".$idprod."/".$photos[$i]."' alt='".$photos[$i]."'></div>";
      }
    }
    if($video!="")
    {
      echo"<div class='carousel-item'><video controls class='d-block w-100' src='/catalogue/".$idprod."/".$video."'></video></div>";
    }
    ?>
  </div>
...
<div class="prix">Prix: <?php echo $prix ?></div><br>
...
<?php
  ...
  echo"<input type=hidden name='idmodele' value='".$idmodele."'><input type=hidden name='stock' value='".$stock."'>";
  ?>
