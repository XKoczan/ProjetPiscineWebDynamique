...
foreach($_SESSION as $elem)
{
       ...
       foreach($results as $result)
       {
           ...
           echo ("
                    ...
                    <div class='elem'>
                        ...
                        <div class='supp'>
                            <a href='supprimerpanier.php?id=$result->idprod'><img src='del2.png' style='height:40%; width:20%;'></a><br>
                        </div> 
   ...
   echo "<h4>Prix total du panier :$prixtotal €" ;
    echo"<h3><a href='formulairepanier.php'><input type='button' value='Acheter'></a></h3>";
require'footer.php';
}
