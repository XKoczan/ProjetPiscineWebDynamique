<head>
    <!-- On fait appel au Jquery et bootstrap, on fait appel à notre page css pour le design-->
        <meta charset="utf-8">
    ...
    <header>
            <a href="ProjetPiscine.php"><img id="logo" src="ECE-Paris.jpg" width= 20% height= 20%></a>
            <p id="lien-inscription"><a href="Formulaire-acheteur.php">S'inscrire</a></p>
        <!--Barre de navigation du site avec les liens vers les pages principales -->
                 ...
                 <div class="collapse navbar-collapse row"  id="navi">
                     ...
                     <ul class="navbar-nav">
                        ...
                        <li class="dropdown col-lg-2" id="navielem"><a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Catégories<span lass="caret"></span></a>
                         ...
                         <li class="nav-item col-lg-2" id="navielem"><a class="nav-link" href="Vendre.php">Vendre</a></li>
                         ...
                         <li class="nav-item col-lg-2" id="navielem"><a class="nav-link" href="admin.php?origine=header">Admin</a></li>
