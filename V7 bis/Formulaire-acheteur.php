<?php
//On appelle en require l'initialisation d'un BDD et d'une session panier (ini.var) et le header
require 'init.var.php';
require 'header.php';

//Si le bouton est pressé
if(isset($_POST['Inscription'])){
//Si les 2 mdp saisies sont identiques
if($_POST['Mdp']==$_POST['Mdp2']){
    ...
    {
        //On confirme l'inscription par un message echo
        echo '<div id="inscription_message">Votre inscription a bien été prise en compte</div>';
    }
    
}else{
        //On indique que les mots de passes saisies ne sont pas identiques
...
?>
<html id="acheteur">
    <!-- On crée un formulaire d'inscription composé des différents type d'informations demandées-->
    <form  action="" method="post">
        <!-- On mets les champs en "required afin d'avoir une valeur lors de l'envoi du form" -->
