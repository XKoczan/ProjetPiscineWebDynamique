...
if ($_POST['fichiersource']=='pannier.php')
{
    echo("<html>
<body>
...
<form method="POST">
    <table>
        ...
        <tr>
            <td><button type="submit" name="Connexion"><a href='Formulaire-acheteur.php'></a></button></td>
        </tr>
    </table>
</form>
</body>
...
<form method="POST">
    <table>
        ...
        <tr>
            <td><button type="submit" name="Connexion"><a href='moncompte.php'></a></button></td>
        </tr>
    </table>
</form>
</body>
