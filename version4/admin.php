...
$req="SELECT * FROM cataloguemodele cm, catalogue c WHERE c.idprod = cm.idprod";
    $qry = $db->prepare($req);
    $qry->execute();
    $items=$qry->fetchAll(PDO::FETCH_OBJ);
echo("<header><h1>Catalgue</h1></header>");
       ...
       if($item->stock!=0)
        {
            echo ("
                <div class ='catalogue'>
                    ...
                    <div class='panierpic'><a href='supprimerarticle.bdd.php?id=$item->idmodele' rel='nofollow'><img src='panier.jpg' style='height:100%; width:100%;'></a></div>
