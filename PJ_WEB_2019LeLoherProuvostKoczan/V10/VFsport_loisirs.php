...
require 'header.php';
// Requete sql
    $req="SELECT * FROM cataloguemodele cm, catalogue c WHERE c.categorie LIKE 'Loisirs et sports' AND c.idprod = cm.idprod ORDER BY cm.`nb_vente` DESC";
               ...
               echo ("
                <div class ='catalogue'>
                    ...
                    <div class='panierpic'>
                        ...
                        <input type='hidden' name='nomfic' value='VFsport_loisirs.php'>
