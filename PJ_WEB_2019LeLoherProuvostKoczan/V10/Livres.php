...
require 'header.php';
// Requete sql
    $req="SELECT * FROM cataloguemodele cm, catalogue c WHERE c.categorie LIKE 'Livres' AND c.idprod = cm.idprod ORDER BY cm.idprod ASC";
    ...
    $produit=0;
// Titre de la page
echo("<header><h1>Livres</h1></header>");
                   ...
                   echo ("
                    <div class ='catalogue'>
                        ...
                        <div class='panierpic'>
                            ...
                            <input type='hidden' name='nomfic' value='Livres.php'>
